...
import 'package:untitled2/dashboard_application_screens/update_user/update_user_navigator.dart';
import 'package:untitled2/dashboard_application_screens/update_user/update_user_view_model.dart';
import 'package:untitled2/shared/base.dart';
import 'package:untitled2/shared/componentes/customWidets/desktop_titleAndInputField.dart';
import 'package:untitled2/shared/componentes/customWidets/page_title.dart';
              ...
              child: Column(
                children: [
                  ...
                  DesktopTitleAndInputField(
                    ...
                    validatorFunction: (text) =>
                        viewModel.phoneValidation(text),
                  ),
                  SizedBox(
                    height: MediaQuery.of(context).size.height * 0.03,
                  ),
                  ...
                  DesktopTitleAndInputField(
                    ...
                    validatorFunction: (text) => viewModel
                        .typeValidation(text), // TODO : there is something
                  ),
                  Expanded(
                    child: Align(
